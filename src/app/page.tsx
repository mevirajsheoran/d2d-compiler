  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 mix-blend-difference">
        <div className="max-w-[1400px] mx-auto px-8 py-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link href="/auth/sign-in" className="text-sm hover:opacity-60 transition-opacity">
              Sign In
            </Link>
            <Link href="/auth/sign-up">
              <Button size="sm" className="bg-white text-black hover:bg-white/90 rounded-full px-5 h-9 text-sm">
                Start Free
              </Button>
            </Link>
          </div>
      ...
      <section className="min-h-screen relative flex items-center">
        ...
        <div className="w-full lg:w-1/2 px-8 lg:px-16 pt-32 pb-20 lg:py-0">
          <div className="max-w-xl">
            ...
            <p className="mt-8 text-lg text-gray-400 leading-relaxed max-w-md animate-fade-in-delay-2">
              Draw wireframes. AI transforms them into production-ready React components. 
              That simple.
            </p>
            ...
            <div className="mt-10 flex items-center gap-4 animate-fade-in-delay-3">
              <Link href="/auth/sign-up">
                <Button className="h-12 px-8 bg-white text-black hover:bg-white/90 rounded-full text-base font-medium">
                  Start Creating
        ...
        {/* Right Side - Canvas Preview (floating, no container) */}
        <div className="hidden lg:block absolute right-0 top-0 bottom-0 w-[55%]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="relative">
              {/* Frame label */}
              <span className="absolute -top-6 left-0 text-xs text-gray-600 font-mono">Frame 1</span>
      ...
      {/* ===== WHAT IT DOES - Horizontal Scroll Text ===== */}
      <section className="py-20 border-t border-gray-900 overflow-hidden">
        <div className="flex whitespace-nowrap animate-scroll">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-center gap-8 px-8 text-7xl md:text-8xl font-bold text-gray-900 tracking-tighter">
              <span>Draw</span>
      ...
      {/* ===== FEATURES - Editorial Style, Not Cards ===== */}
      <section id="features" className="py-32">
        <div className="max-w-[1400px] mx-auto px-8">
          {/* Section header - Left aligned */}
          <FadeInOnScroll>
            <div className="max-w-2xl mb-24">
              <p className="text-sm text-gray-500 mb-4 tracking-widest uppercase">What you get</p>
          ...
          {/* Features as a flowing list, not grid */}
      ...
      <section id="how-it-works" className="py-32 bg-gradient-to-b from-transparent via-gray-950 to-transparent">
        <div className="max-w-[1400px] mx-auto px-8">
          <FadeInOnScroll>
            <div className="text-center mb-20">
              <p className="text-sm text-gray-500 mb-4 tracking-widest uppercase">Process</p>
      ...
      {/* ===== PRICING - Minimal, No Cards ===== */}
      <section id="pricing" className="py-32">
        <div className="max-w-[1400px] mx-auto px-8">
          <FadeInOnScroll>
            <div className="max-w-2xl mb-20">
              <p className="text-sm text-gray-500 mb-4 tracking-widest uppercase">Pricing</p>
              <h2 className="text-5xl md:text-6xl font-bold tracking-tight leading-[1.1]">
                Start free.<br />
          ...
          {/* Pricing as table/list, not cards */}
          <FadeInOnScroll>
            <div className="border-t border-gray-800">
              <PricingRow
                name="Free"
                price="₹0"
                features={["5 AI generations/mo", "3 projects", "All tools", "Auto save"]}
              ...
              <PricingRow
                name="Pro Monthly"
                price="₹499/mo"
                features={["100 generations/mo", "Unlimited projects", "Priority support", "Style guide AI"]}
                highlighted
                comingSoon
              />
              ...
              <PricingRow
                name="Pro Yearly"
                price="₹4,999/yr"
                features={["1200 generations/yr", "Unlimited projects", "Priority support", "Style guide AI"]}
                badge="Save 17%"
                comingSoon
              />
            </div>
      ...
      <section className="py-32 relative">
        ...
        <FadeInOnScroll>
          <div className="relative max-w-[1400px] mx-auto px-8 text-center">
            ...
            <Link href="/auth/sign-up">
              <Button className="h-14 px-10 bg-white text-black hover:bg-white/90 rounded-full text-lg font-medium">
                Start Creating
...
/* ============================================================
   COMPONENTS - No boxes, flowing design
   ============================================================ */
...
function FeatureRow({
  ...
  return (
    <div className="group border-t border-gray-800 py-8 md:py-12 grid md:grid-cols-12 gap-6 items-start hover:bg-white/[0.02] transition-colors px-4 -mx-4">
      {/* Number */}
...
function ProcessStep({
  ...
  return (
    <div className={`relative py-12 md:py-16 flex ${position === "right" ? "md:flex-row-reverse" : ""}`}>
      {/* Content */}
      <div className={`flex-1 ${position === "right" ? "md:pl-20 md:text-right" : "md:pr-20"}`}>
        <div className="flex items-center gap-3 mb-4 ${position === 'right' ? 'md:justify-end' : ''}">
          {position === "right" && comingSoon && (
            <Badge className="text-[10px] py-0 px-2 bg-violet-500/10 text-violet-400 border-violet-500/20">
              Coming Soon
            </Badge>
          )}
          <span className={`text-4xl font-bold ${colors[color].split(" ")[1]}`}>{number}</span>
      ...
      <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className={`w-4 h-4 rounded-full ${colors[color].split(" ")[0]}`} />
      </div>
...
function PricingRow({
  ...
  return (
    <div className={`border-b border-gray-800 py-8 grid md:grid-cols-12 gap-6 items-center ${highlighted ? "bg-white/[0.02]" : ""}`}>
      {/* Plan name */}
      ...
      <div className="md:col-span-3 flex md:justify-end">
        {comingSoon ? (
          <Button disabled variant="outline" size="sm" className="rounded-full border-gray-800 text-gray-600">
